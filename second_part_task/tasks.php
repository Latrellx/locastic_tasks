...
<body>
    ...
    <div class="wrapper">
        <div class="container">          
            ...
            <div class="row">
                <?php     
                    $lists = $list->getTasksByList(Input::get('id'));
                        ...
                        <div class="row">                                       
                            <div class="col-xs-12">
                                ...
                                <div class="table-responsive m-t-20">
                                    ...
                                    <tbody>
                                    <?php 
                                        $tasks = $list->getTasksPerList($item->id);      
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <a href="edit_task.php?id=<?php echo $task->id ?>" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" class="table-action-btn"><i class="fa fa-pencil"></i></a>
